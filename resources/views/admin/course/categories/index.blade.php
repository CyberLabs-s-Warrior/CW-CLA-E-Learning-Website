...
@section('content')
  <div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      {{-- Search --}}
      <form method="GET" action="{{ route('admin.course-categories.index') }}" class="d-flex gap-2">
        <input type="hidden" name="tab" id="activeTabInput" value="{{ request('tab', 'kategori') }}">
        ...
        @if(request('search'))
        <a href="{{ route('admin.course-categories.index', ['tab' => request('tab', 'kategori')]) }}"
