...
<div class="container-fluid py-4">
  ...
  <div class="card border-0 shadow-sm rounded-4">
    ...
    <div class="card-body">
      <form id="editPriceForm" method="POST" action="{{ route('admin.course-prices.update', $price->id) }}" class="d-flex flex-column gap-3">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
          <div class="col-md-6">
            ...
            <input
              ...
              value="{{ old('min_price', $price->min_price) }}"
          ...
          <div class="col-md-6">
            ...
            <input
              ...
              value="{{ old('max_price', $price->max_price) }}"
        ...
        <div class="d-flex gap-2 mt-3 align-items-center">
          <button type="submit" id="submitBtn" class="btn btn-danger rounded-pill px-4 d-flex align-items-center">
