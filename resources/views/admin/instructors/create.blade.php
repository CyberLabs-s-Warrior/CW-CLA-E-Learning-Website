...
@section('title','Buat Profil Instruktur')
...
<div class="container-fluid py-3 py-md-4 instructor-create">
  ...
  <form action="{{ route('admin.instruktur.store') }}" method="post" enctype="multipart/form-data"
        ...
        <div class="col-lg-8">
          <div class="mb-3">
            ...
            <select name="user_id" class="form-select @error('user_id') is-invalid @enderror" required>
              ...
              @foreach($instructorCandidates as $u)
          ...
          <div class="mt-3">
            ...
            <textarea name="short_bio"
                      ...
                      required
                      oninput="window.updateBioCount(this)">{{ old('short_bio') }}</textarea>
    ...
    <div class="card-footer bg-white d-flex flex-column flex-sm-row gap-2 justify-content-end p-3 p-md-3 rounded-bottom-4">
      <a href="{{ route('admin.instruktur.index') }}" class="btn btn-light">Batal</a>
