    ...
    <header class="hero container" aria-labelledby="course-title">
        ...
        <div class="hero-info">
            ...
            <ul class="quick-facts" aria-label="Informasi singkat kursus">
                ...
                <li><i class="fa-solid fa-signal" aria-hidden="true"></i> Tingkat: {{ $course->level?->level ?? '-' }}</li>
                            ...
                            <div class="mentor-info">
                                ...
                                <div class="links" aria-label="Sosial">
                                    @if($mentor->github_url)
                                        <a href="{{ $mentor->github_url }}" target="_blank" rel="noopener" aria-label="GitHub">
                                            <i class="fa-brands fa-github"></i>
                                        </a>
                                    @endif
                                    @if($mentor->linkedin_url)
                                        <a href="{{ $mentor->linkedin_url }}" target="_blank" rel="noopener" aria-label="LinkedIn">
    ...
    <section class="container recos" aria-label="Rekomendasi kursus">
        ...
        <div class="reco-row">
            @forelse ($relatedCourses as $rel)
                <a class="reco-card card-hover" href="{{ route('detail.index', $rel->slug) }}" aria-label="Lihat {{ $rel->name }}">
