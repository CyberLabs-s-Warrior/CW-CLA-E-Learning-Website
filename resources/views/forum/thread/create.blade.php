...
@push('styles')
  <link rel="stylesheet" href="{{ asset('guest/forum-compose.css') }}?v={{ filemtime(public_path('guest/forum-compose.css')) }}">
@endpush
...
<section class="compose-wrap" aria-labelledby="composeTitle">
  <div class="compose-container">
    ...
    <form method="POST"
          action="{{ route('forum.thread.store') }}"
          id="threadForm"
          class="compose-card"
      ...
      <div class="field">
        ...
        <select id="category_id" name="category_id" required
                class="js-selectx @error('category_id') is-invalid @enderror"
                data-search="true"
      ...
      <div class="field">
        ...
        <textarea id="body" name="body"
                  class="textarea @error('body') is-invalid @enderror"
      ...
      <div class="field">
        ...
        <div class="uploader" id="uploader">
          ...
          @error('image') <div class="error-msg mt-6">{{ $message }}</div> @enderror
        </div>
      </div>
