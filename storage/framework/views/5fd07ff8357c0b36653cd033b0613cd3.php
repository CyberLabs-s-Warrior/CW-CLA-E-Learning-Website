<?php $__env->startSection('title', 'Edit Kursus Detail'); ?>
...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4">
      <div class="card-body">
        <form action="<?php echo e(route('admin.detail.update', $detail)); ?>" method="POST" id="course-form">
          <?php echo csrf_field(); ?>
          ...
          <div class="mb-4">
            ...
            <select name="course_id" id="course_id" class="form-select shadow-sm" required>
              ...
              <?php $__currentLoopData = $courseList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($id); ?>" <?php echo e(old('course_id', $detail->course_id) == $id ? 'selected' : ''); ?>>
                  <?php echo e($name); ?>
          ...
          <div class="mb-4">
            ...
            <div id="instructor-wrapper">
              ...
              ?>
              <?php $__empty_1 = true; $__currentLoopData = $selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="input-group mb-2 instructor-item">
                  <select name="instructors[]" class="form-select shadow-sm instructor-select" required>
                    ...
                    <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($ins->id); ?>"
                        data-avatar="<?php echo e($ins->avatar_path ? asset('storage/' . $ins->avatar_path) : '/default-avatar.png'); ?>"
                        data-skill="<?php echo e($ins->primary_skill); ?>"
                        <?php echo e($insId == $ins->id ? 'selected' : ''); ?>>
                        <?php echo e($ins->user->name); ?>

                      </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <button type="button" class="btn btn-outline-danger btn-remove-instructor <?php echo e($loop->first ? 'd-none' : ''); ?>">
          ...
          <div class="mb-3">
            ...
            <textarea name="description" id="description" class="form-control shadow-sm editor" rows="4"><?php echo e(old('description', $detail->description)); ?></textarea>
          </div>

          
          <div class="mb-3">
            <label for="outcomes" class="form-label fw-semibold">Hasil yang Dicapai</label>
            <textarea name="outcomes" id="outcomes" class="form-control shadow-sm editor" rows="3"><?php echo e(old('outcomes', $detail->outcomes)); ?></textarea>
          </div>
          ...
          <div class="d-flex gap-2 mt-4">
            ...
            <a href="<?php echo e(route('admin.detail.index')); ?>" class="btn btn-secondary rounded-pill px-4 shadow-sm">
...
<?php echo $__env->make('templates.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/admin/detail/edit.blade.php ENDPATH**/ ?>