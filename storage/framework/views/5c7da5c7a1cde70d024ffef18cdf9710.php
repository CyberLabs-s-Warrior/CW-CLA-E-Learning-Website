<?php $__env->startSection('title', 'Edit Konten About'); ?>
...
<div class="container-fluid py-4">
  ...
  <div class="card shadow-sm border-0 rounded-4">
    <div class="card-body">
      <form id="editForm" action="<?php echo e(route('admin.about.update', $content->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                 value="<?php echo e(old('section', $content->section)); ?>" placeholder="Ketik atau pilih section..." required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
          ...
          <input type="text" name="title"
                 class="form-control rounded-3 shadow-sm <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $content->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
          ...
          <?php if($content->image): ?>
            <img src="<?php echo e(asset('storage/' . $content->image)); ?>" class="img-thumbnail rounded shadow-sm mt-2" width="120" alt="Current Image">
          <?php else: ?>
...
<?php echo $__env->make('templates.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/admin/about/edit.blade.php ENDPATH**/ ?>