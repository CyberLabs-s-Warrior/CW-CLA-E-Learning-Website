<?php $__env->startPush('styles'); ?>
  <link rel="stylesheet" href="<?php echo e(asset('guest/contact.css')); ?>">
<?php $__env->stopPush(); ?>
          ...
          <div class="card__body">
            ...
            <div class="card__text">
              ...
              <?php if(!empty($contact?->email)): ?>
                <div class="card__value">
                  <a href="mailto:<?php echo e($contact->email); ?>" class="contact-link"><?php echo e($contact->email); ?></a>
                </div>
              <?php else: ?>
            ...
            <?php if(!empty($contact?->email)): ?>
              <div class="card__actions">
                <a class="btn-chip" href="mailto:<?php echo e($contact->email); ?>">
        ...
        <div class="card">
          <div class="card__body">
            ...
            <div class="card__text">
              ...
              <?php if($tel): ?>
                <div class="card__value">
                  <a href="tel:<?php echo e($telHref); ?>" class="contact-link"><?php echo e($tel); ?></a>
                </div>
              <?php else: ?>
                <div class="card__value card__value-muted">-</div>
              <?php endif; ?>
            ...
            <?php if($tel && $telHref): ?>
              <div class="card__actions">
                <a class="btn-chip" href="tel:<?php echo e($telHref); ?>">
        ...
        <div class="card" style="grid-column: 1 / -1;">
          <div class="card__body">
            ...
            <div class="card__text">
              ...
              <div class="card__value">
                <span class="contact-address"><?php echo e($contact->alamat ?? '-'); ?></span>
              </div>
            </div>

            <?php if($gmapsClick): ?>
              <div class="card__actions">
                <a class="btn-chip" href="<?php echo e($gmapsClick); ?>" target="_blank" rel="noopener">
            ...
            <div class="card__text">
              ...
              <?php else: ?>
                <div class="d-flex flex-wrap gap-2">
                  <?php if($fb): ?><a class="btn-chip" href="<?php echo e($fb); ?>" target="_blank" rel="noopener"><i class="fab fa-facebook me-1"></i>Facebook</a><?php endif; ?>
                  <?php if($ig): ?><a class="btn-chip" href="<?php echo e($ig); ?>" target="_blank" rel="noopener"><i class="fab fa-instagram me-1"></i>Instagram</a><?php endif; ?>
                  <?php if($tt): ?><a class="btn-chip" href="<?php echo e($tt); ?>" target="_blank" rel="noopener"><i class="fab fa-tiktok me-1"></i>TikTok</a><?php endif; ?>
                  <?php if($xx): ?><a class="btn-chip" href="<?php echo e($xx); ?>" target="_blank" rel="noopener"><i class="fab fa-x-twitter me-1"></i>X</a><?php endif; ?>
                </div>
              <?php endif; ?>
            </div>
          </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/guest/contact/index.blade.php ENDPATH**/ ?>