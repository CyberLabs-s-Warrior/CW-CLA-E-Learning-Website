...
<nav class="app-header navbar navbar-expand bg-body border-bottom shadow-sm">
  ...
  <a class="nav-link d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    <?php if(Auth::user()->foto): ?>
      <img src="<?php echo e(asset('storage/' . Auth::user()->foto)); ?>"
           ...
           width="32" height="32">
    <?php else: ?>
      <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=6c757d&color=fff&size=32"
           alt="<?php echo e(Auth::user()->name); ?> Avatar"
           class="rounded-circle me-2"
           width="32" height="32">
    <?php endif; ?>
  ...
  <ul class="dropdown-menu dropdown-menu-end animate__animated animate__fadeIn" style="min-width: 200px;">
    ...
    <li>
      <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.profile.show')); ?>">
...
<?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/templates/header.blade.php ENDPATH**/ ?>