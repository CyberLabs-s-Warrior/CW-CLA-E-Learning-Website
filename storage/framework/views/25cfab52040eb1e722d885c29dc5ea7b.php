...
<div class="container-fluid py-4">
  ...
  <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 mb-4">
    ...
    <a href="<?php echo e(route('admin.contact.index')); ?>" class="btn btn-light border rounded-pill px-3">
    ...
    <div class="col-12 col-lg-6 order-2 order-lg-1">
      <div class="card card-elev border-0 rounded-4 h-100">
        <div class="card-body p-4">
          <form action="<?php echo e(route('admin.contact.update')); ?>" method="POST" id="editContactForm" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-4">
              ...
              <textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="Nama jalan, nomor, kelurahan, kecamatan, kota"><?php echo e(old('alamat', $contact->alamat ?? '')); ?></textarea>
            </div>
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input type="url" name="social_facebook" id="social_facebook" class="form-control"
                        ...
                        value="<?php echo e(old('social_facebook', $contact->social_facebook ?? '')); ?>">
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="url" name="social_instagram" id="social_instagram" class="form-control"
                        ...
                        value="<?php echo e(old('social_instagram', $contact->social_instagram ?? '')); ?>">
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="url" name="social_tiktok" id="social_tiktok" class="form-control"
                        ...
                        value="<?php echo e(old('social_tiktok', $contact->social_tiktok ?? '')); ?>">
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="url" name="social_x" id="social_x" class="form-control"
                        ...
                        value="<?php echo e(old('social_x', $contact->social_x ?? '')); ?>">
                </div>
              </div>
            ...
            <!-- HIDDEN KOORDINAT -->
            <input type="hidden" name="latitude" id="latitude" value="<?php echo e(old('latitude', $contact->latitude ?? '')); ?>">
            <input type="hidden" name="longitude" id="longitude" value="<?php echo e(old('longitude', $contact->longitude ?? '')); ?>">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="url" name="link_maps" id="link_maps" class="form-control"
                       ...
                       value="<?php echo e(old('link_maps', $contact->link_maps ?? '')); ?>">
              </div>
              <div class="form-text">
...
<?php echo $__env->make('templates.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/admin/contact/edit.blade.php ENDPATH**/ ?>