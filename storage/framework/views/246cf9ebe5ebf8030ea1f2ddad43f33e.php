...
<div class="container-fluid py-4">
  ...
  <div class="d-flex align-items-center gap-2 mb-4">
    ...
    <div class="ms-auto d-flex gap-2">
      <a href="<?php echo e(route('admin.contact.edit')); ?>" class="btn btn-warning btn-sm">
          ...
          <?php else: ?>
            <div class="list-group list-group-flush">
              ...
              <div class="list-group-item py-3">
                ...
                <div class="<?php echo e($alamat ? '' : 'text-muted'); ?>"><?php echo e($alamat ?? '-'); ?></div>
                <?php if($gmapsClick): ?>
                  <div class="mt-2">
                    <a href="<?php echo e($gmapsClick); ?>" target="_blank" rel="noopener" class="btn btn-outline-primary btn-sm">
              ...
              <div class="list-group-item py-3">
                ...
                <?php if($telepon): ?>
                  <a href="tel:<?php echo e($telHref); ?>"><?php echo e($telepon); ?></a>
                <?php else: ?>
                  <span class="text-muted">-</span>
                <?php endif; ?>
              </div>
              ...
              <div class="list-group-item py-3">
                ...
                <?php else: ?>
                  <div class="d-flex flex-wrap gap-2">
                    <?php if($fb): ?>
                      <a href="<?php echo e($fb); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-light border">
                        <i class="fab fa-facebook me-1"></i>Facebook
                      </a>
                    <?php endif; ?>
                    <?php if($ig): ?>
                      <a href="<?php echo e($ig); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-light border">
                        <i class="fab fa-instagram me-1"></i>Instagram
                      </a>
                    <?php endif; ?>
                    <?php if($tt): ?>
                      <a href="<?php echo e($tt); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-light border">
                        <i class="fab fa-tiktok me-1"></i>TikTok
                      </a>
                    <?php endif; ?>
                    <?php if($xx): ?>
                      <a href="<?php echo e($xx); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-light border">
              ...
              <div class="list-group-item py-3">
                ...
                <?php if($lat && $lng): ?>
                  <div class="d-flex flex-wrap align-items-center gap-2">
                    <span class="badge bg-light text-dark border">Lat: <span id="latVal"><?php echo e(number_format((float)$lat, 6, '.', '')); ?></span></span>
                    <span class="badge bg-light text-dark border">Lng: <span id="lngVal"><?php echo e(number_format((float)$lng, 6, '.', '')); ?></span></span>
        ...
        <div class="card border-0 shadow-sm rounded-4">
          ...
          <div class="card-body p-0">
            <?php if($gmapsEmbed): ?>
              <div class="ratio ratio-16x9">
                <iframe src="<?php echo e($gmapsEmbed); ?>" style="border:0" allowfullscreen loading="lazy"
          ...
          <?php if($gmapsClick): ?>
            <div class="card-footer bg-white">
              <a href="<?php echo e($gmapsClick); ?>" target="_blank" rel="noopener" class="btn btn-primary btn-sm">
                <i class="fab fa-google me-1"></i>Buka di Google Maps
              </a>
            </div>
          <?php endif; ?>
...
<?php echo $__env->make('templates.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>