<?php $__env->startSection('title','Edit Profil Instruktur'); ?>
...
<div class="container-fluid py-3 py-md-4 instructor-edit">
  ...
  <div class="d-flex flex-column flex-md-row align-items-md-center gap-2 mb-3">
    <div>
      <h1 class="h4 mb-0">Edit Profil: <?php echo e($profile->user->name ?? 'Instruktur'); ?></h1>
  ...
  <form action="<?php echo e(route('admin.instruktur.update', $profile)); ?>" method="post" enctype="multipart/form-data"
        ...
        <div class="col-lg-8">
          ...
          <div class="row g-3">
            <div class="col-md-8">
              ...
              <input type="text"
                     name="primary_skill"
                     value="<?php echo e(old('primary_skill',$profile->primary_skill)); ?>"
                     maxlength="120"
                     required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
              ...
              <input type="number"
                     name="sort_order"
                     value="<?php echo e(old('sort_order',$profile->sort_order)); ?>"
                     min="0"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('short_bio',$profile->short_bio)); ?></textarea>
              ...
              <div class="mb-3">
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox"
                         ...
                         <?php echo e(old('is_published', $profile->is_published) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="text-center">
                <div class="ratio ratio-1x1 rounded-3 overflow-hidden bg-white border"
                  ...
                  <img id="avatarPreview"
                       src="<?php echo e($current ?: $placeholder); ?>"
                       alt="Foto <?php echo e($profile->user?->name ?? 'Instruktur'); ?>"
    ...
    <div class="card-footer bg-white d-flex flex-column flex-sm-row gap-2 justify-content-end p-3 p-md-3 rounded-bottom-4">
      <a href="<?php echo e(route('admin.instruktur.index')); ?>" class="btn btn-light">Kembali</a>
...
<?php echo $__env->make('templates.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/admin/instructors/edit.blade.php ENDPATH**/ ?>