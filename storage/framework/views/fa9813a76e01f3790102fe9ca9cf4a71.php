...
<head>
  <meta charset="utf-8">
  <title>Verifikasi Email - <?php echo e($appName); ?></title>
...
<body style="margin:0;padding:0;background:#f5f7fb;">
  <div class="preheader">
    Verifikasi email Anda untuk menyelesaikan pendaftaran <?php echo e($appName); ?>.
  </div>
      ...
      <td align="center" style="padding:24px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;background:#ffffff;border-radius:12px;border:1px solid #e6eaf0;">
          ...
          <tr>
            <td align="center" style="padding:28px 28px 0 28px;">
              ...
              <?php if(isset($logoUrl)): ?>
                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($appName); ?>" width="56" height="56" style="display:block;border:0;border-radius:12px;">
              <?php endif; ?>
          ...
          <tr>
            <td align="center" style="padding:20px 28px 0 28px;">
              <a href="<?php echo e($link); ?>"
                 style="display:inline-block;background:<?php echo e($primary); ?>;color:#ffffff;text-decoration:none;
                        font:600 14px/1 system-ui,-apple-system,Segoe UI,Arial,sans-serif;
                        padding:14px 22px;border-radius:10px;border:1px solid <?php echo e($primary); ?>;">
                Verifikasi Email
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 28px 0 28px;">
              ...
              <p style="word-break:break-all;margin:8px 0 0;">
                <a href="<?php echo e($link); ?>" style="color:<?php echo e($primary); ?>;text-decoration:underline;font:500 12px/1.6 system-ui,-apple-system,Segoe UI,Arial,sans-serif;">
                  <?php echo e($link); ?>
          ...
          <tr>
            <td style="padding:16px 28px 0 28px;">
              <p style="margin:0;font:400 12px/1.7 system-ui,-apple-system,Segoe UI,Arial,sans-serif;color:#64748b;">
                <?php if(isset($expiresAt)): ?>
                  Tautan ini berlaku hingga <strong><?php echo e($expiresAt->timezone('Asia/Jakarta')->format('d M Y H:i')); ?> WIB</strong>.
                <?php else: ?>
          ...
          <tr>
            <td style="padding:16px 28px 0 28px;">
              <p style="margin:0;font:400 12px/1.7 system-ui,-apple-system,Segoe UI,Arial,sans-serif;color:#64748b;">
                Tidak merasa mendaftar di <?php echo e($appName); ?>? Abaikan email ini. Bila butuh bantuan, hubungi kami di
                <?php if($supportMail): ?>
                  <a href="mailto:<?php echo e($supportMail); ?>" style="color:<?php echo e($primary); ?>;text-decoration:underline;"><?php echo e($supportMail); ?></a>.
                <?php else: ?>
                  email dukungan kami.
                <?php endif; ?>
              </p>
          ...
          <tr>
            <td align="center" style="padding:28px;">
              <p style="margin:0;font:400 11px/1.7 system-ui,-apple-system,Segoe UI,Arial,sans-serif;color:#94a3b8;">
                © <?php echo e(now()->year); ?> <?php echo e($appName); ?>. Semua hak dilindungi.
              </p>
            </td>
          </tr>
        </table>
...
<?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/mail/verify-pending.blade.php ENDPATH**/ ?>