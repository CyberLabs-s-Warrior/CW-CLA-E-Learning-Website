    ...
    <nav class="footer-links" aria-label="Tautan utama">
      <div class="mnav" data-collapsible>
        ...
        <ul id="footerMainMenu" class="mnav-list" role="list">
          ...
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('katalog.index')); ?>"><i
                class="fas fa-folder-open"></i><span>Katalog</span></a>
          </li>
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('testimoni.index')); ?>"><i
          ...
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('instruktur.index')); ?>"><i
                class="fas fa-chalkboard-teacher"></i><span>Instruktur</span></a>
          </li>
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('about.index')); ?>"><i
                class="fas fa-circle-info"></i><span>About</span></a>
          </li>
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('contact.index')); ?>"><i
                class="fas fa-envelope"></i><span>Contact</span></a>
          </li>
          <li class="mnav-item">
            <a class="mnav-link" href="<?php echo e(route('showcase.index')); ?>"><i
...
<?php $__env->stopPush(); ?><?php /**PATH D:\PKL\CW-CLA-E-Learning-Website\resources\views/components/footer.blade.php ENDPATH**/ ?>